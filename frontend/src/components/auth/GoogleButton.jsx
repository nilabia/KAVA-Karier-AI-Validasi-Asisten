...
export default function GoogleButton({ onClick, disabled, text = "Continue with Google" }) {
    return (
        <button
        type="button"
        onClick={onClick}
        ...
        <div className="absolute inset-0 bg-[#303030] opacity-0 transition-opacity duration-[218ms] 
            group-hover:not-disabled:opacity-[8%] 
            group-focus:not-disabled:opacity-[12%] 
            group-active:not-disabled:opacity-[12%]" 
        />
